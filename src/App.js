    ...
    <div className="App">
      <section className="hero is-fullheight has-background">
            ...
            <div className="container">
              ...
              <div id="navbarMenuHeroA" className="navbar-menu">
                <div className="navbar-end">
                  <a className="navbar-item is-size-3 is-active" href="#">
                    Home
                  </a>
        ...
        <div className="hero-body">
          <div className="container">
            <p className="title is-size-1">TIAGO MATOS</p>
            ...
            <div className="container">
              <div className="columns">
                <div className="column is-narrow">
                  <a className="button is-dark is-outlined is-large" href={require('./assets/Resume-TiagoMatos.docx.new.pdf')}>
                    View Resume
                  </a>
                </div>
                <div className="column is-narrow">
                  <a className="button is-dark is-outlined is-large" href={require('./assets/Resume-TiagoMatos.docx.new.pdf')} download>
                    Download Resume
                  </a>
                </div>
      ...
      <section className="section">
        <div className="container">
          <div className="heading">
            <div className="subtitle has-text-centered is-size-3">
